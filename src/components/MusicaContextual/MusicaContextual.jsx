        ...
        <>
          <div className={verMusicaContextual}>
            ...
            <div className="contenedor__MContextual">
              <form action="">
                <div className="MC_selects__contenedor">
                  ...
                  <select
                    ...
                    id=""
                    className="MC__select"
                    defaultValue="Estado de Ánimo"
                  >
                    <option disabled>Estado de Ánimo</option>
                ...
                <div className="MC__genero">
                  ...
                  <div className="genero__contenedor">
                    {listaGenero.map((genero) => {
                      return (
                        <span
                          onClick={() => recuperarGeneros(genero.id)}
                          className={`genero__item ${
                            listaGeneros.includes(genero.id)
                              ? "generoSeleccionado"
                              : ""
                          }`}
                          key={genero.id}
              ...
              <button className="MC__boton" onClick={crearPlaylist}>
                Crear Playlist
              </button>
            </div>
          </div>
